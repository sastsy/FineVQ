...
from internvl.model.internvl_chat_infer import (InternVisionConfig,
                                          InternVisionModel,
                                          InternVLChatConfig,
                                          InternVLChatModel)
            ...
            try:
                ...
                data_item = {
                    ...
                    'conversations': [
                        {
                            'from': 'human',
                            'value': '<|video|> Considering the artifact dimension, how would you rate the quality of this video?'
                        },
                        {
                            'from': 'ai',
                            'value': 'The quality of this video is good.'
                        }
                    ]
                }
